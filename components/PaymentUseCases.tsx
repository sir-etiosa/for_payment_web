...
import { PAYMENT_USE_CASES } from "@/lib/constants";
  ...
  return (
    <Section className="py-20 md:py-28">
      <div className="mb-12 text-center">
        <Eyebrow>Payment use cases</Eyebrow>
        <h2 className="mt-4 font-display text-3xl font-bold tracking-tight text-ink sm:text-4xl">
          Wherever your customers pay,
          <br className="hidden sm:block" /> you settle in seconds.
        </h2>
      </div>
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {PAYMENT_USE_CASES.map((uc) => (
          ...
          >
            ...
            <p className="mt-2 text-sm leading-relaxed text-slate">{uc.body}</p>
          </div>
        ))}
      </div>
    </Section>
